                    ...
                    <table class="table table-dark table-striped text-light">
                        ...
                        <tbody>
                            <tr ng-repeat="currentGame in ctrl.games">
                                ...
                                <td></td>
                                <td><button class='btn btn-secondary btn-sm' data-ng-click="ctrl.selectGame(currentGame)">Select</button></td>
                                <td><button class='btn btn-danger btn-sm' data-ng-click="ctrl.deleteGame(currentGame)">Delete</button></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
